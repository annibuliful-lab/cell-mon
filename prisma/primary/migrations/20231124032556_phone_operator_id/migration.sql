/*
  ...
  - A unique constraint covering the columns `[mnc,mcc,country,countryCode,brand,operator]` on the table `phone_operator` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE INDEX "phone_operator_mcc_mnc_idx" ON "phone_operator"("mcc", "mnc");

-- CreateIndex
CREATE UNIQUE INDEX "phone_operator_mnc_mcc_country_countryCode_brand_operator_key" ON "phone_operator"("mnc", "mcc", "country", "countryCode", "brand", "operator");
